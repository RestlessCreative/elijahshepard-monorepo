//$( document ).ready(function() {
  if($('#ear-worms').length > 0) {
      ...
      */
           ...
           var elms = ['track', 'timer', 'duration', 'playBtn', 'pauseBtn', 'prevBtn', 'nextBtn', 'playlistBtn', 'volumeBtn', 'progress', 'bar', 'wave', 'waveform', 'loading', 'playlist', 'list', 'volume', 'barEmpty', 'barFull', 'sliderBtn'];
           ...
           Player.prototype = {
             ...
             play: function(index) {
               ...
               if (data.howl) {
                 ...
                 mediaURL = "https://assets.elijahshepard.com/es-main/ear-worms/tracks/";
                 sound = data.howl = new Howl({
                   //src: ['./audio/' + data.file + '.webm', './audio/' + data.file + '.mp3'],
                   src: [mediaURL + data.file + '.webm', mediaURL + data.file + '.mp3'],
